...
public class PagamentoServiceTest {
	...
	public void should_register_payment() {
		...
		when(cartaoService.isSaldoSuficiente(anyInt(), anyInt(), Mockito.any(BigDecimal.class))).thenReturn(true);
	...
	public void should_not_register_payment_no_money() {
		...
		when(cartaoService.isValido(anyInt(), anyInt())).thenReturn(true);
		when(cartaoService.isSaldoSuficiente(anyInt(), anyInt(), Mockito.any(BigDecimal.class))).thenReturn(false);
